...
hero:
  ...
  actions:
    - text: Quickstart
      link: /vitasync/quickstart
      icon: right-caret
      variant: primary
    - text: API Reference
      link: /vitasync/api-reference/introduction
      icon: open-book
---
...
<CardGrid>
  ...
  <Card title="AI & Analytics" icon="star">
  ...
  <Card title="Notification System" icon="forward-slash">
  ...
  <Card title="Goals & Achievements" icon="star">
  ...
  <Card title="Health Tracking" icon="list-format">
  ...
  <Card title="Sleep Analysis & Biometrics" icon="approve-check">
...
|----------|------|---------|------|
| [Fitbit](/vitasync/providers/fitbit) | OAuth 2.0 + PKCE | Steps, heart rate, sleep, body composition, SpO₂ | Every 15 min |
| [Garmin](/vitasync/providers/garmin) | OAuth 1.0a | Steps, GPS workouts, HRV, stress, body battery | Push (real-time) |
| [WHOOP](/vitasync/providers/whoop) | OAuth 2.0 | Recovery, strain, HRV, sleep performance | Every 15 min |
| [Strava](/vitasync/providers/strava) | OAuth 2.0 | Workouts, distance, calories, GPS routes | On-demand |

See [Supported Providers](/vitasync/providers/supported) for a full metric-by-metric comparison.
...
The [Quickstart guide](/vitasync/quickstart) walks through each step in detail with copy-pasteable curl commands.
