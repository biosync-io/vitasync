  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Configure notification channels and routing rules. All settings are stored per-user in the database."
      />
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button size="sm" icon={Plus} onClick={() => { setShowCreate(true); setEditingId(null) }}>
          Add Channel
        </Button>
      </div>
      ...
      {isLoading ? (
        ...
        <DSEmptyState
          icon={Bell}
          title="No notification channels configured yet"
          description="Add your first channel to start receiving notifications."
          action={{ label: "Add Channel", onClick: () => { setShowCreate(true); setEditingId(null) }, icon: Plus }}
        />
      ) : (
        <>
                      ...
                      <div className="flex items-start gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            <Badge variant={ch.enabled ? "success" : "default"} size="sm">
  ...
  return (
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <DSEmptyState
          icon={ListFilter}
          title="No routing rules configured yet"
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-2 text-xs text-gray-500 dark:text-gray-400">
                        <span>
                          Min severity:{" "}
                          <Badge
                            variant={rule.minSeverity === "critical" ? "danger" : rule.minSeverity === "warning" ? "warning" : "info"}
                            size="sm"
                          >
                            {rule.minSeverity}
                          </Badge>
...
// ── Shared components ─────────────────────────────────────────────
// LoadingSpinner and EmptyState replaced by design system components:
// CardSkeleton and DSEmptyState (imported above).
