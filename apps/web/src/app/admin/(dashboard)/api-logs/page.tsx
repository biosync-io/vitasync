...
import { PageHeader, Card, CardHeader, CardContent, StatCard, Badge, EmptyState, TableSkeleton } from "../../../../lib/components/ui"
...
export default function ApiLogsPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="API Logs"
        subtitle="Record of all API calls with request/response details."
      />
      ...
      {stats && (
        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
          ...
          <StatCard label="Error Rate" value={stats.errorRate} color="accent" />
      ...
      {isLoading ? (
        ...
        <EmptyState icon={FileText} title="No API logs found" description="No logs match your current filters." />
      ) : (
        <>
          {/* Desktop table */}
                    ...
                    <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <Badge variant={
                          ...
                          log.statusCode < 500 ? "warning" : "danger"
                        } size="sm">
                          {log.statusCode}
                        </Badge>
                      </td>
